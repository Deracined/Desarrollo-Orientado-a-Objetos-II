...
public class Main {
    ...
    // Declaramos los pedidos demostrando polimorfismo ya que cada uno cambia su comportamieto dependiendo de su subclase
        ...
        controlador.mostrarHistorial(pedido1);
        ...
        controlador.mostrarHistorial(pedido2);
        ...
        // También cancelamos este pedido para ejemplificar un caso distinto //
        controlador.despachar(pedido3);
        controlador.cancelar(pedido3);
        controlador.mostrarHistorial(pedido3);
    }
}